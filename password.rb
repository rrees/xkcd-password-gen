...
def password()
	password_tokens = [
		...
		['lime', 'lemon', 'mango', 'grapefruit', 'orange', 'apple', 'blueberry', 'strawberry', 'raspberry', 'pineapple'],
		['sailor', 'doctor', 'driver', 'fireman', 'conductor', 'reporter', 'rasta', 'angel'],
		['singing', 'dancing', 'running', 'skating', 'driving', 'hiding', 'shouting', 'howling', 'shaking'],
		['trumpet', 'horn', 'piano', 'drum', 'recorder', 'xylophone', 'oboe', 'flute', 'harp'],
		['kangaroo', 'wombat', 'koala', 'emu', 'ostrich', 'dingo'],
		['desert', 'ocean', 'island', 'cape', 'delta', 'fjord', 'tundra', 'plains', 'grassland'],
	]
